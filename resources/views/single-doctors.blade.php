          ...
          <div class="doctor-hero-content">
            ...
            <div class="doctor-meta">
              <div class="doctor-meta-item">
                <svg class="doctor-meta-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <template x-if="submitted">
                <div
                  ...
                  <div class="success-icon-wrapper !bg-white">
                    <svg class="success-icon !text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
