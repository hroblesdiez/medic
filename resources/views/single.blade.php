...
<article @php(post_class('bg-white'))>
  {{-- Header Section --}}
  <header class="py-8 lg:py-12 bg-surface-soft">
    <div class="max-w-4xl mx-auto px-4">
      ...
      <h1 class="text-3xl lg:text-5xl font-bold text-(--color-text-primary) mb-8 leading-tight">
        {!! get_the_title() !!}
      </h1>

      <div class="flex flex-wrap items-center justify-between gap-6 border-t border-border-light pt-8">
  ...
  {{-- Featured Image --}}
  <div class="max-w-6xl mx-auto px-4 mb-16 lg:mb-24">
    <div class="aspect-21/9 rounded-(--radius-2xl) overflow-hidden shadow-2xl border-4 border-white">
